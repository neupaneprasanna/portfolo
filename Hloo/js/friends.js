...
const friendsData = [
    { name: "Sandesh Rai", role: "Closest Buddy", image: "assets/images/sandesh.jpg", description: "'He can switch from singing to dancing faster than most people can unlock their phones. Every moment is a chance for him to drop a beat or strike a pose. If life had background music, he'd definitely be the one performing it.'" },
    ...
    { name: "Aashutosh Kafle", role: "Professor Specs", image: "ashutosh.jpg", description: "'With glasses perched perfectly, he can spot mistakes from a mile away - especially in homework. Books fear him, exams respect him, and everyone else just quietly takes notes. Basically, he's the human version of a cheat sheet, but way cooler.'" },
...
// Start the 3D animated entrance immediately
